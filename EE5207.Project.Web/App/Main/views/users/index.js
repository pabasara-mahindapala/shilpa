        ...
        function ($scope, $timeout, $uibModal, userService) {
            ...
            function getUsers() {
                userService.getAll({}).then(function (result) {
                    ...
                    //userService.getUserAttendances(3);
                });
            }
            ...
            vm.openUserDetailModal = function (user) {
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/users/detailModal.cshtml',
                    controller: 'app.views.users.detailModal as vm',
                    backdrop: 'static',
                    resolve: {
                        id: function () {
                            return user.id;
            ...
            vm.exportToPdf = function () {
                document.getElementById('printids').style.display = "block";
                html2canvas(document.getElementById('printids'), {
                    onrendered: function (canvas) {
                        ...
                        pdfMake.createPdf(docDefinition).download("UsedIds.pdf");
                        document.getElementById('printids').style.display = "none";
                    }
                });
